export default async function scanCharaInfo(charaNameParameter) {
  ...
  try {
    ...
    let audioUrl = 'https:' + (dom.window.document.querySelector("#mw-content-text > div.mw-parser-output > table.wikitable.character > tbody > tr:nth-child(18) > td").dataset.voice);
